# Open‑Core Documentation (Trimmed)

This repository follows an open‑core model:

- Core protocol and Solana program are open and permissively licensed.
- Proprietary extensions (data pipelines, dashboards, integrations) live out of tree.
- No vendor lock‑in, no proprietary dependencies in the core.

Scope retained here:
- Minimal architecture notes in `README.md`
