...
mod tests {
    ...
    fn error_codes_match_anchor() {
        ...
        assert_eq!(error_code(OracleError::ChannelStakePoolNotInitialized), 6027);
        ...
        assert_eq!(error_code(OracleError::MarketTokensAlreadyInitialized), 6058);
    ...
    fn exported_constants_match() {
        assert_eq!(ORACLE_ERROR_NO_REWARDS_TO_CLAIM, error_code(OracleError::NoRewardsToClaim));
        assert_eq!(ORACLE_ERROR_POOL_IS_SHUTDOWN, error_code(OracleError::PoolIsShutdown));
        assert_eq!(ORACLE_ERROR_CLAIM_EXCEEDS_AVAILABLE, error_code(OracleError::ClaimExceedsAvailableRewards));
    }
