...
pub enum OracleError {
    ...
    // VAULT
    // =========================================================================
    #[msg("Attention multiplier exceeds maximum allowed (5.0x = 50000 BPS)")]
    MaxMultiplierExceeded,

    #[msg("No yield available to claim")]
    NothingToClaim,

    #[msg("Strategy reserve would fall below the configured minimum")]
    InsufficientReserve,

    #[msg("Strategy deployment exceeds the configured utilization cap")]
    UtilizationCapExceeded,

    #[msg("Strategy vault is not active")]
    StrategyInactive,

    #[msg("Strategy amount is below the minimum threshold")]
    StrategyAmountTooSmall,

    #[msg("Invalid external account for strategy CPI")]
    InvalidExternalAccount,

    #[msg("Invalid external state for strategy CPI")]
    InvalidExternalState,

    #[msg("Requested withdrawal exceeds available strategy balance")]
    InsufficientStrategyBalance,

    // =========================================================================
    // PRICE FEED
    // =========================================================================
    #[msg("Price deviation exceeds maximum allowed (20%)")]
    ...
    // =========================================================================
    // PHASE 2 NAV / V5 CLAIMS (appended to preserve existing error codes)
    // =========================================================================
    #[msg("Invalid merkle leaf version")]
    InvalidMerkleLeafVersion,

    #[msg("Attention multiplier is below minimum allowed (1.0x = 10000 BPS)")]
    MultiplierBelowMinimum,

    #[msg("NAV per share cannot decrease")]
    NavDecreaseNotAllowed,

    #[msg("NAV per share is below minimum allowed (1.0x = 10000 BPS)")]
    NavBelowMinimum,

    #[msg("NAV per share exceeds maximum allowed (5.0x = 50000 BPS)")]
    NavAboveMaximum,
