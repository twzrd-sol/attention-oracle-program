use crate::{
    constants::{ADMIN_AUTHORITY, EPOCH_FORCE_CLOSE_GRACE_SECS, EPOCH_STATE_SEED, PROTOCOL_SEED},
    errors::OracleError,
...
pub fn force_close_epoch_state_legacy(
    ...
    require!(
        now - ctx.accounts.epoch_state.timestamp >= EPOCH_FORCE_CLOSE_GRACE_SECS,
