//! Verbatim copy of `programs/ao-v2/src/keccak.rs` (the live AO runtime's
//! dependency-free Keccak-256). Copied rather than shared because ao-v2 is a
//! standalone, immutable-deployed crate; keep this file byte-identical to it.
