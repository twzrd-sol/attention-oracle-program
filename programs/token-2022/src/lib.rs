...
pub(crate) use instructions::admin::__client_accounts_update_publisher as __client_accounts_update_publisher;
#[allow(unused_imports)]
pub(crate) use instructions::admin::__client_accounts_update_publisher_open as __client_accounts_update_publisher_open;
#[allow(unused_imports)]
pub(crate) use instructions::admin::__client_accounts_set_policy as __client_accounts_set_policy;
#[allow(unused_imports)]
pub(crate) use instructions::admin::__client_accounts_set_policy_open as __client_accounts_set_policy_open;
#[allow(unused_imports)]
pub(crate) use instructions::admin::__client_accounts_set_paused as __client_accounts_set_paused;
#[allow(unused_imports)]
pub(crate) use instructions::admin::__client_accounts_set_paused_open as __client_accounts_set_paused_open;
#[allow(unused_imports)]
pub(crate) use instructions::channel::__client_accounts_set_channel_merkle_root as __client_accounts_set_channel_merkle_root;
#[allow(unused_imports)]
pub(crate) use instructions::channel::__client_accounts_claim_channel as __client_accounts_claim_channel;
#[allow(unused_imports)]
pub(crate) use instructions::channel::__client_accounts_claim_channel_with_receipt as __client_accounts_claim_channel_with_receipt;
#[allow(unused_imports)]
pub(crate) use instructions::claim::__client_accounts_claim as __client_accounts_claim;
#[allow(unused_imports)]
pub(crate) use instructions::claim::__client_accounts_claim_open as __client_accounts_claim_open;
#[allow(unused_imports)]
pub(crate) use instructions::cleanup::__client_accounts_close_epoch_state as __client_accounts_close_epoch_state;
#[allow(unused_imports)]
pub(crate) use instructions::cleanup::__client_accounts_close_epoch_state_open as __client_accounts_close_epoch_state_open;
#[allow(unused_imports)]
pub(crate) use instructions::cleanup::__client_accounts_force_close_epoch_state_legacy as __client_accounts_force_close_epoch_state_legacy;
#[allow(unused_imports)]
pub(crate) use instructions::cleanup::__client_accounts_force_close_epoch_state_open as __client_accounts_force_close_epoch_state_open;
#[allow(unused_imports)]
pub(crate) use instructions::governance::__client_accounts_update_fee_config as __client_accounts_update_fee_config;
#[allow(unused_imports)]
pub(crate) use instructions::hooks::__client_accounts_transfer_hook as __client_accounts_transfer_hook;
#[allow(unused_imports)]
pub(crate) use instructions::initialize_mint::__client_accounts_initialize_mint as __client_accounts_initialize_mint;
#[allow(unused_imports)]
pub(crate) use instructions::initialize_mint::__client_accounts_initialize_mint_open as __client_accounts_initialize_mint_open;
#[allow(unused_imports)]
pub(crate) use instructions::liquidity::__client_accounts_trigger_liquidity_drip as __client_accounts_trigger_liquidity_drip;
#[allow(unused_imports)]
pub(crate) use instructions::merkle::__client_accounts_set_merkle_root as __client_accounts_set_merkle_root;
#[allow(unused_imports)]
pub(crate) use instructions::merkle::__client_accounts_set_merkle_root_open as __client_accounts_set_merkle_root_open;
#[allow(unused_imports)]
pub(crate) use instructions::merkle_ring::__client_accounts_initialize_channel as __client_accounts_initialize_channel;
#[allow(unused_imports)]
pub(crate) use instructions::merkle_ring::__client_accounts_set_merkle_root_ring as __client_accounts_set_merkle_root_ring;
#[allow(unused_imports)]
pub(crate) use instructions::merkle_ring::__client_accounts_claim_with_ring as __client_accounts_claim_with_ring;
#[allow(unused_imports)]
pub(crate) use instructions::merkle_ring::__client_accounts_close_old_epoch_state as __client_accounts_close_old_epoch_state;
#[allow(unused_imports)]
pub(crate) use instructions::passport::__client_accounts_mint_passport_open as __client_accounts_mint_passport_open;
#[allow(unused_imports)]
pub(crate) use instructions::passport::__client_accounts_upgrade_passport_open as __client_accounts_upgrade_passport_open;
#[allow(unused_imports)]
pub(crate) use instructions::passport::__client_accounts_reissue_passport_open as __client_accounts_reissue_passport_open;
#[allow(unused_imports)]
pub(crate) use instructions::passport::__client_accounts_revoke_passport_open as __client_accounts_revoke_passport_open;
#[allow(unused_imports)]
pub(crate) use instructions::passport::__client_accounts_upgrade_passport_proved as __client_accounts_upgrade_passport_proved;
#[allow(unused_imports)]
pub(crate) use instructions::points::__client_accounts_claim_points_open as __client_accounts_claim_points_open;
#[allow(unused_imports)]
pub(crate) use instructions::points::__client_accounts_require_points as __client_accounts_require_points;
...
pub mod token_2022 {
    ...
    /// Optional: Require Layer‑1 receipt if protocol_state.require_receipt=true
    pub fn claim_open(
