...
**Repositioning (2026-09-05, decided 2026-09-06)**: `docs/aop-trust-rail-repositioning.md` —
move AOP's role from streaming attention (listen payouts, attention-metric markets — inert on
mainnet) to backing the trust gate, buyer corpus, and facilitator rail. Step 1 (adapter-side
`settlement_tx`) landed in wzrd-final #2831. Step 2 design:
`docs/aop-step2-attestation-corpus.md`. Item 6 below is the surface those fact types change.
