...
async function main() {
  ...
  const maxFee = 100000000000; // 100 MILO (9 decimals)
  ...
  try {
    ...
    console.log('\n✅ Protocol initialized (OPEN variant)!');
