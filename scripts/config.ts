...
export const CCM_HOOK_PROGRAM_ID = new PublicKey(
  optionalEnv("CCM_HOOK_PROGRAM_ID", "8VE2Wt5JNusGUCwkrpVmdwgdgyD6vYPEHop2g2CAArzS")
);
...
export const PUBLIC_CONFIG = {
  ...
  // Programs (explicit naming to avoid ambiguity with future programs)
  aoProgramId: PROGRAM_ID.toBase58(),
  ccmHookProgramId: CCM_HOOK_PROGRAM_ID.toBase58(),
...
export function printConfig(): void {
  console.log("=== CCM-v3 Config ===");
  console.log("Program ID:", PROGRAM_ID.toBase58());
  console.log("CCM Hook:", CCM_HOOK_PROGRAM_ID.toBase58());
  console.log("CCM-v3 Mint:", CCM_V3_MINT.toBase58());
